import { FaGithub, FaHeart, FaLinkedin, FaMailBulk, FaMailchimp, FaTwitter } from "react-icons/fa";
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                item-center gap-6">
                     ...
                     <div className="flex gap-4 justify-center">
                        <a 
                        href="https://github.com/sakshi8287-UI"
                        ...
                        <a 
                        href="https://www.linkedin.com/in/sakshi-sharma-61b7a8385/"
                        className="w-10 h-10 rounded-full flex items-center 
                        justify-center hover:scale-110 transition-all
                        hover:bg-linear-to-r hover:from-orange-500
                        hover:to-amber-500 hover:text-white
